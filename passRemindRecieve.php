...
<main class="wrap">
  ...
  <div class="container">
    ...
    <p style="padding:0 0 50px;">メールアドレスにお送りの認証コードをご入力ください
      <br>パスワードを再発行いたします</p>
    <form method="post" class="narrow">
      <div class ="regi-user">
        <div class="email-form">
          <label class="<?php if (!empty($err_msg['auth_key'])) echo 'err'; ?>">パスコード
            <span><?php echo showErrMsg('auth_key'); ?></span>
            <input type="text" name="auth_key" placeholder="" value="<?php echo getFormData('auth_key') ?>">
          </label>
        </div>
